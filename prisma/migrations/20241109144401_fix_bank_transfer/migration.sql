/*
  ...
  - The values [BACK_TRANSFER] on the enum `TransactionPaymentMethod` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TransactionPaymentMethod_new" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'BACK_SLIP', 'CASH', 'PIX', 'OTHER');
